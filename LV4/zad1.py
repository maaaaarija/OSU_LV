...
numerickih ulaznih velicina. Detalje oko ovog podatkovnog skupa mogu se pronaci u 3. laboratorijskoj vježbi.
...
print(f"theta_0: {linearModel.intercept_}")
print(f"theta_1...m: {linearModel.coef_}")
