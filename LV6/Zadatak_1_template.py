'''
Zadatak 6.5.1 Skripta zadatak_1.py ucitava Social_Network_Ads.csv skup podataka [2].
...
te prikažite dobivenu granicu odluke. Mijenjajte vrijednost hiperparametra C i γ(gamma). Kako promjena
...
Zadatak 6.5.4 Pomocu unakrsne validacije odredite optimalnu vrijednost hiperparametra C i γ (gamma)
...
SVM_model = svm.SVC(kernel='rbf', gamma=0.9, C=5)
...
# promjena tipa kernela mijenja oblik granice odluke
